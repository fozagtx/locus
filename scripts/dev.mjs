#!/usr/bin/env node
// One command to run Locus locally: server + convex + debug dashboard + ngrok.
...
console.log(`\nLocus dev starting on port ${port}. Ctrl-C to stop everything.\n`);
