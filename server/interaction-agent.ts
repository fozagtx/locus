...
import { sendImessage } from "./spectrum.js";
import { aggregateUsageFromResult, EMPTY_USAGE, type UsageTotals } from "./usage.js";

const INTERACTION_SYSTEM = `You are Locus, a personal agent the user texts from iMessage.

Identity: You are NOT Claude, Claude Code, Anthropic, an AI assistant from Anthropic, or any other AI brand. Never say or imply you are. If asked who or what you are, you are Locus. If asked who built you, you are Locus — do not name the underlying model unless the user explicitly invokes set_model / get_config tools.
...
When the user asks about Locus itself, pick the tool by intent:
...
- Telling Locus where they are or what timezone they want → set_timezone
  ...
  try {
    for await (const msg of query({
      ...
      options: {
        ...
        mcpServers: {
          "locus-memory": memoryServer,
          "locus-spawn": spawnServer,
          "locus-automations": automationServer,
          "locus-draft-decisions": draftDecisionServer,
          "locus-ack": ackServer,
          "locus-self": selfServer,
        },
        allowedTools: [
          "mcp__locus-memory__write_memory",
          "mcp__locus-memory__recall",
          "mcp__locus-spawn__spawn_agent",
          "mcp__locus-automations__create_automation",
          "mcp__locus-automations__list_automations",
          "mcp__locus-automations__toggle_automation",
          "mcp__locus-automations__delete_automation",
          "mcp__locus-draft-decisions__list_drafts",
          "mcp__locus-draft-decisions__send_draft",
          "mcp__locus-draft-decisions__reject_draft",
          "mcp__locus-ack__send_ack",
          "mcp__locus-self__get_config",
          "mcp__locus-self__set_model",
          "mcp__locus-self__set_timezone",
          "mcp__locus-self__list_integrations",
          "mcp__locus-self__search_composio_catalog",
          "mcp__locus-self__inspect_toolkit",
        ],
      ...
      if (msg.type === "assistant") {
        ...
        for (const block of msg.message.content) {
          if (block.type === "text") {
            ...
            const name = block.name.replace(/^mcp__locus-[a-z-]+__/, "");
